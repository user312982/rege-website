<template>
  <div class="bg-gray-900 bg-cover bg-center" :style="{ backgroundImage: `url(${heroBg})` }">
    ...
    <div class="relative isolate px-6 pt-14 lg:px-8">
      ...
      <div class="mx-auto max-w-2xl min-h-[calc(100vh-120px)] py-16 sm:py-24">
        <div class="text-center">
          <h1 class="text-5xl font-regular tracking-tight text-balance text-white sm:text-6xl">“Empowering Tomorrow with Clean Energy Today.”</h1>
        </div>
      </div>
